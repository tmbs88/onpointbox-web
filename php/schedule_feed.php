...
function parseDateTime($string, $timezone=null) {
	$date = new DateTime(
		$string,
		$timezone ? $timezone : new DateTimeZone('Europe/Lisbon')
...
//------------------------------------------------------------------------------------------//
	...
	//trigger_error('range '.var_dump($range_start).' - '.var_dump($range_end));
	...
	$resdb = $dbHandler->selectAllSchedule();
	
	// Accumulate an output array of event data arrays.
	$output_arrays = array();
	foreach ($resdb['rows'] as $array) {
